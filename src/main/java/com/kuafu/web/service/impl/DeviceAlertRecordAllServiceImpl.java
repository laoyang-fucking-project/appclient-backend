...
import com.kuafu.web.mapper.DeviceAlertRecordAllMapper;
 ...
 */
@Slf4j
@Service("DeviceAlertRecordAll")
public class DeviceAlertRecordAllServiceImpl extends ServiceImpl<DeviceAlertRecordAllMapper, DeviceAlertRecordAll> implements IDeviceAlertRecordAllService {
@Autowired
private DeviceAlertRecordAllMapper taskInfoAllMapper;


@Override
public List<DeviceAlertRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<DeviceAlertRecordAll> queryWrapper) {

        LambdaQueryWrapper<DeviceAlertRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<DeviceAlertRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<DeviceAlertRecordAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<DeviceAlertRecordAll> queryWrapper) {
        LambdaQueryWrapper<DeviceAlertRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<DeviceAlertRecordAll> page, PageRequest pageRequest, LambdaQueryWrapper<DeviceAlertRecordAll> queryWrapper) {
