...
import com.kuafu.web.mapper.SensorDataRecordAllMapper;
 ...
 */
@Slf4j
@Service("SensorDataRecordAll")
public class SensorDataRecordAllServiceImpl extends ServiceImpl<SensorDataRecordAllMapper, SensorDataRecordAll> implements ISensorDataRecordAllService {
@Autowired
private SensorDataRecordAllMapper taskInfoAllMapper;


@Override
public List<SensorDataRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<SensorDataRecordAll> queryWrapper) {

        LambdaQueryWrapper<SensorDataRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<SensorDataRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<SensorDataRecordAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<SensorDataRecordAll> queryWrapper) {
        LambdaQueryWrapper<SensorDataRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<SensorDataRecordAll> page, PageRequest pageRequest, LambdaQueryWrapper<SensorDataRecordAll> queryWrapper) {
