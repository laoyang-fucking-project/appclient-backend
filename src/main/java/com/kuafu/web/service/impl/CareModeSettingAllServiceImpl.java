...
import com.kuafu.web.mapper.CareModeSettingAllMapper;
 ...
 */
@Slf4j
@Service("CareModeSettingAll")
public class CareModeSettingAllServiceImpl extends ServiceImpl<CareModeSettingAllMapper, CareModeSettingAll> implements ICareModeSettingAllService {
@Autowired
private CareModeSettingAllMapper taskInfoAllMapper;


@Override
public List<CareModeSettingAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<CareModeSettingAll> queryWrapper) {

        LambdaQueryWrapper<CareModeSettingAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<CareModeSettingAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<CareModeSettingAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<CareModeSettingAll> queryWrapper) {
        LambdaQueryWrapper<CareModeSettingAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<CareModeSettingAll> page, PageRequest pageRequest, LambdaQueryWrapper<CareModeSettingAll> queryWrapper) {
