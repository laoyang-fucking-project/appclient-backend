...
import com.kuafu.web.mapper.AiChatRecordAllMapper;
 ...
 */
@Slf4j
@Service("AiChatRecordAll")
public class AiChatRecordAllServiceImpl extends ServiceImpl<AiChatRecordAllMapper, AiChatRecordAll> implements IAiChatRecordAllService {
@Autowired
private AiChatRecordAllMapper taskInfoAllMapper;


@Override
public List<AiChatRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<AiChatRecordAll> queryWrapper) {

        LambdaQueryWrapper<AiChatRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<AiChatRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<AiChatRecordAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<AiChatRecordAll> queryWrapper) {
        LambdaQueryWrapper<AiChatRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<AiChatRecordAll> page, PageRequest pageRequest, LambdaQueryWrapper<AiChatRecordAll> queryWrapper) {
