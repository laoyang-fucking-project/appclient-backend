...
import com.kuafu.web.mapper.DeviceControlLogAllMapper;
 ...
 */
@Slf4j
@Service("DeviceControlLogAll")
public class DeviceControlLogAllServiceImpl extends ServiceImpl<DeviceControlLogAllMapper, DeviceControlLogAll> implements IDeviceControlLogAllService {
@Autowired
private DeviceControlLogAllMapper taskInfoAllMapper;


@Override
public List<DeviceControlLogAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<DeviceControlLogAll> queryWrapper) {

        LambdaQueryWrapper<DeviceControlLogAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<DeviceControlLogAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<DeviceControlLogAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<DeviceControlLogAll> queryWrapper) {
        LambdaQueryWrapper<DeviceControlLogAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<DeviceControlLogAll> page, PageRequest pageRequest, LambdaQueryWrapper<DeviceControlLogAll> queryWrapper) {
